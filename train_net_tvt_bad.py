...
# - create a function that updates the weights, but doesn't
#   use dropout
...
# calculate testing loss
      ...
      print("Epoch: %d, train_loss=%f, train_accuracy=%f, valid_loss=%f, valid_accuracy=%f, test_loss=%f, test_accuracy=%f, time=%fs"
            % (epoch_num + 1, train_loss, train_accuracy, valid_loss, valid_accuracy, test_loss, test_accuracy, total_time))
